...
class _ForcedDataProducer extends ForcedDataProducer {
  ...
  @override
  void read() {
    _metaWearBoardPrivate
        .lookupProducer(ProximityTsl2671Impl.PRODUCER)
        .read(_metaWearBoardPrivate);
  }

  @override
  Future<Route> addRouteAsync(RouteBuilder builder) {
    return _metaWearBoardPrivate.queueRouteBuilder(
        builder, ProximityTsl2671Impl.PRODUCER);
  }
...
class ProximityTsl2671Impl extends ModuleImplBase implements ProximityTsl2671 {
  ...
  static const String PRODUCER =
      "com.mbientlab.metawear.impl.ProximityTsl2671Impl.PRODUCER";
  ...
  ProximityTsl2671Impl(MetaWearBoardPrivate mwPrivate) : super(mwPrivate) {
    mwPrivate.tagProducer(
        PRODUCER,
        new UintData(ModuleType.PROXIMITY, Util.setSilentRead(ADC),
