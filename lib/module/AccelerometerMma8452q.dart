...
class FullScaleRange {
  ...
  static List<FullScaleRange> _entires = [FSR_2G, FSR_4G, FSR_8G];
...
enum Oversampling { NORMAL, LOW_NOISE_LOW_POWER, HIGH_RES, LOW_POWER }
...
abstract class ConfigEditor
    implements Accelerometer.ConfigEditor<ConfigEditor> {
...
class Movement {
  ...
  String toString() => sprintf(
          ...
          [
            exceedsThreshold(CartesianAxis.X),
            polarity(CartesianAxis.X),
            exceedsThreshold(CartesianAxis.Y),
            polarity(CartesianAxis.Y),
            exceedsThreshold(CartesianAxis.Z),
            polarity(CartesianAxis.Z)
          ]);
...
abstract class ShakeDataProducer
    with AsyncDataProducer
    implements Configurable<ShakeConfigEditor> {}
...
abstract class TapDataProducer
    with AsyncDataProducer
    implements Configurable<TapConfigEditor> {}
...
class Tap {
  ...
  String toString() => sprintf(
          ...
          [
            active(CartesianAxis.X),
            polarity(CartesianAxis.X),
            active(CartesianAxis.Y),
            polarity(CartesianAxis.Y),
            active(CartesianAxis.Z),
            polarity(CartesianAxis.Z)
          ]);
  ...
  bool operator ==(other) =>
      other is Tap &&
      ListEquality().equals(this.actives, other.actives) &&
...
abstract class MovementDataProducer
    with AsyncDataProducer
    implements Configurable<MovementConfigEditor> {}
