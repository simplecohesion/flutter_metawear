...
class FunctionBuilder {
  ...
  FunctionBuilder.abs()
      : handler = Function1.ABS_VALUE,
        target = null;
  FunctionBuilder.rms()
      : handler = Function1.RMS,
        target = null;
  FunctionBuilder.rss()
      : handler = Function1.RSS,
        target = null;
  FunctionBuilder.sqrt()
      : handler = Function1.SQRT,
        target = null;

  FunctionBuilder.add(dynamic target)
      : handler = Function2.ADD,
        this.target = target;
  FunctionBuilder.multiply(dynamic target)
      : handler = Function2.MULTIPLY,
        this.target = target;
  FunctionBuilder.divide(dynamic target)
      : handler = Function2.DIVIDE,
        this.target = target;
  FunctionBuilder.modulus(dynamic target)
      : handler = Function2.MODULUS,
        this.target = target;
  FunctionBuilder.exponent(dynamic target)
      : handler = Function2.EXPONENT,
        this.target = target;
  FunctionBuilder.leftShift(dynamic target)
      : handler = Function2.LEFT_SHIFT,
        this.target = target;
  FunctionBuilder.rightShift(dynamic target)
      : handler = Function2.RIGHT_SHIFT,
        this.target = target;
  FunctionBuilder.subtract(dynamic target)
      : handler = Function2.SUBTRACT,
        this.target = target;
  FunctionBuilder.constant(dynamic target)
      : handler = Function2.CONSTANT,
        this.target = target;
}
